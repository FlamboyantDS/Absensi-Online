                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1">Deskripsi Perusahaan</label>
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Email Domain</label>
                                <input type="email" class="form-control" id="exampleFormControlInput1"
                                    placeholder="name@example.com">
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Alamat Website</label>
                                <input type="email" class="form-control" id="exampleFormControlInput1"
                                    placeholder="name@example.com">
                            </div>
                        </form>
                        <form>
                            <label class="col-sm-2 control-label">Example file input</label>
                            <div class="col-sm-6">
                                <img src="" alt="" height="50">
                                <br>
                                <br>
                                <input type="file" class="btn btn-default" id="exampleFormControlFile1">
                            </div>
                        </form>
                        <!-- /.panel -->
                    </div>
